...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        self.set_home_position(float(lon0),float(lat0),0) #position of global home.
        ...
        print('lati: {0}, longi: {1}, alti: {2}'.format(longi,lati,alti))
        ...
        # print('current_local_position[0]:')
        # print(current_local_pos[0])
        # print('current_local_position[1]')
        # print(current_local_pos[1])
        
        # Set goal as some arbitrary position on the grid
        # grid_goal = (north_offset + 10, east_offset + 10)
        # -122.397337,37.792570 -> Succeed
        # -122.397337,37.793800 -> Succeed
        # -122.397337,37.795000 -> Crashed the building but succeed to find a route
        # -122.397337,37.796500 -> park

        # -122.397350,37.792570 -> Failed
        # -122.397934,37.794700 -> Crashed
        # -122.402224,37.797330 -> Criteria


        goal_local_position = global_to_local([-122.399337,37.796500,self.global_home[2]],self.global_home)
        # print('goal_local_position[0]:')
        # print(goal_local_position[0])
        # print('goal_local_position[1]')
        # print(goal_local_position[1])
